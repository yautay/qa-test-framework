...
def test_report_endpoint_logs_single_skip_entry_when_reporting_disabled(
    ...
    monkeypatch.setattr("framework.visual.report_server.services.pdf._generate_bug_pdf", lambda **_kwargs: ("/tmp/report.pdf", 1))
    logged: list[tuple[str, dict[str, Any]]] = []

    def _debug(msg: str, **kwargs: Any) -> None:
        logged.append((msg, kwargs))

    monkeypatch.setattr("framework.visual.report_server.services.sync.logger.debug", _debug)
