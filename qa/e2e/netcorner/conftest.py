...
def _dismiss_cookie_popup_at_test_start(page: Page, timeout_ms: int = 10000) -> None:
    accept_selectors = [
    ...
    while time.perf_counter() < deadline:
        for selector_group in (accept_selectors, reject_selectors):
...
def page(
    ...
    _dismiss_cookie_popup_at_test_start(page, timeout_ms=10000)
    yield page
