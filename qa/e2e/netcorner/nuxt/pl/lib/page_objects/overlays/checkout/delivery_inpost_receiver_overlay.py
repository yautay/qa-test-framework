...
class DeliveryInpostReceiverOverlay(DeliveryStorehouseReceiverOverlay):
    ...
    def search_inpost_points(self, value: str, max_zoom_iterations: int = 40) -> list[StorehouseData]:
    ...
    def get_available_inpost_points(self, max_zoom_iterations: int = 40) -> list[StorehouseData]:
    ...
    def choose_inpost_point_by_name(self, point_name: str, max_zoom_iterations: int = 40) -> StorehouseData:
    ...
    def choose_inpost_point_by_data_id(self, point_data_id: str, max_zoom_iterations: int = 40) -> StorehouseData:
    ...
    def choose_random_inpost_point(self, max_zoom_iterations: int = 40) -> StorehouseData:
