...
class PasswordRecoveryPage(BasePage):
    ...
    def __init__(self, page: Page, base_url: str):
        ...
        self.__content: PasswordRecoveryContentSection | None = None
        self.__navigation: NavigationSection | None = None
        self.__header: HeaderSection | None = None
        self.__footer: FooterSection | None = None

    def wait_loaded(self, *, state: LoadState = "domcontentloaded", timeout: int | None = None) -> PasswordRecoveryPage:
    ...
    @property
    def content(self) -> PasswordRecoveryContentSection:
        if self.__content is None:
            self.__content = PasswordRecoveryContentSection(self.page)
