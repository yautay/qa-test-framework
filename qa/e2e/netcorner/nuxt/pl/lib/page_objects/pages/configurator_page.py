...
class ConfiguratorPage(BasePage):
    PATH = "/advanced-configurator"
    PAGE_ID = "netcorner.pl.configurator.main"

    def __init__(self, page: Page, base_url: str):
        super().__init__(page, base_url)
        self.__content: ConfiguratorContentSection | None = None
        self.__navigation: NavigationSection | None = None
        self.__header: HeaderSection | None = None
        self.__footer: FooterSection | None = None

    def wait_loaded(self, *, state: LoadState = "domcontentloaded", timeout: int | None = None) -> ConfiguratorPage:
    ...
    @property
    def content(self) -> ConfiguratorContentSection:
        if self.__content is None:
            self.__content = ConfiguratorContentSection(self.page)
