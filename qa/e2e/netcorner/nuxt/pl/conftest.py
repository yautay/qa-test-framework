...
def _resolve_pl_nuxt_base_url(server_type: str, server_name: str) -> str:
...
def pytest_configure(config) -> None:
    ...
    resolved_base_url = _resolve_pl_nuxt_base_url(runtime_env.server_type, runtime_env.server_name)
