...
scenario1 = "Scenariusz: \n" \
            "Confluence - \"Ograniczenia koszyka - testy automatyczne cz.2 -- 6.1\"\n" \
...
scenario2 = "Scenariusz: \n" \
            "Confluence - \"Ograniczenia koszyka - testy automatyczne cz.2 -- 6.2\"\n" \
            "   1. Otwiera odpowiedni produkt i dodaje go do koszyka.\n" \
...
scenario3 = "Scenariusz: \n" \
            "Confluence - \"Ograniczenia koszyka - testy automatyczne cz.2 -- 6.3, 6.4, 6.5, 6.6, 6.7\"\n" \
            "   1. Otwiera odpowiedni produkt i dodaje go do koszyka.\n" \
            "   2. Sprawdza czy przycisk 'Przejdź dalej' jest aktywny i przechodzi dalej.\n" \
            "   3. Sprawdza czy przycisk są aktywne.\n" \
...
product_15_dw = {
    "product_number": pl_cart_var["product_number_15"],
    "product_markup": pl_cart_var["product_markup_DW"],
}
product_15_dw.setdefault("scenario", scenario1)

product_15_nd = {
    "product_number": pl_cart_var["product_number_15"],
    "product_markup": pl_cart_var["product_markup_ND"],
}
product_15_nd.setdefault("scenario", scenario1)

product_15_dw_send_from_warehouse = {
    "product_number": pl_cart_var["product_number_15"],
    "product_markup": pl_cart_var["product_markup_DW"],
...
product_15_dw_send_from_warehouse.update(common_test_data.copy())
product_15_dw_send_from_warehouse.setdefault("scenario", scenario2)

product_15_nd_send_from_warehouse = {
    "product_number": pl_cart_var["product_number_15"],
    "product_markup": pl_cart_var["product_markup_ND"],
    "delivery_object": {"order_with": DeliveryMethodKey.COURIER,
                        "receiver_data": PlCommonData.receiver_data(),
...
product_15_nd_send_from_warehouse.update(common_test_data.copy())
product_15_nd_send_from_warehouse.setdefault("scenario", scenario2)

product_15_dw_pickup_gdansk = {
    "product_number": pl_cart_var["product_number_15"],
    "product_markup": pl_cart_var["product_markup_DW"],
...
product_15_dw_pickup_gdansk.update(common_test_data.copy())
product_15_dw_pickup_gdansk.setdefault("scenario", scenario3)

product_15_nd_pickup_gdansk = {
    "product_number": pl_cart_var["product_number_15"],
    "product_markup": pl_cart_var["product_markup_ND"],
    "delivery_object": {"order_with": DeliveryMethodKey.STOREHOUSE,
                        "warehouse": pl_cart_var["warehouse_name_gdansk_ch_baltycka"],
...
product_15_nd_pickup_gdansk.update(common_test_data.copy())
product_15_nd_pickup_gdansk.setdefault("scenario", scenario3)

product_15_dw_pickup_poznan_outlet = {
    "product_number": pl_cart_var["product_number_15"],
    "product_markup": pl_cart_var["product_markup_DW"],
    "delivery_object": {"order_with": DeliveryMethodKey.STOREHOUSE,
                        "warehouse": pl_cart_var["warehouse_name_magazyn_glowny"],
...
product_15_dw_pickup_poznan_outlet.update(common_test_data.copy())
product_15_dw_pickup_poznan_outlet.setdefault("scenario", scenario3)

product_15_nd_pickup_poznan_outlet = {
    "product_number": pl_cart_var["product_number_15"],
    "product_markup": pl_cart_var["product_markup_ND"],
    "delivery_object": {"order_with": DeliveryMethodKey.STOREHOUSE,
                        "warehouse": pl_cart_var["warehouse_name_magazyn_glowny"],
...
product_15_nd_pickup_poznan_outlet.update(common_test_data.copy())
product_15_nd_pickup_poznan_outlet.setdefault("scenario", scenario3)

product_15_dw_pickup_swarzedz = {
    "product_number": pl_cart_var["product_number_15"],
    "product_markup": pl_cart_var["product_markup_DW"],
    "delivery_object": {"order_with": DeliveryMethodKey.STOREHOUSE,
...
product_15_dw_pickup_swarzedz.update(common_test_data.copy())
product_15_dw_pickup_swarzedz.setdefault("scenario", scenario3)

product_15_nd_pickup_swarzedz = {
    "product_number": pl_cart_var["product_number_15"],
    "product_markup": pl_cart_var["product_markup_ND"],
    "delivery_object": {"order_with": DeliveryMethodKey.STOREHOUSE,
                        "warehouse": pl_cart_var["warehouse_name_swarzedz_partnerski"],
...
product_15_nd_pickup_swarzedz.update(common_test_data.copy())
product_15_nd_pickup_swarzedz.setdefault("scenario", scenario3)

product_15_dw_pickup_gniezno_inpost = {
    "product_number": pl_cart_var["product_number_15"],
    "product_markup": pl_cart_var["product_markup_DW"],
...
product_15_dw_pickup_gniezno_inpost.update(common_test_data.copy())
product_15_dw_pickup_gniezno_inpost.setdefault("scenario", scenario3)

product_15_nd_pickup_gniezno_inpost = {
    "product_number": pl_cart_var["product_number_15"],
    "product_markup": pl_cart_var["product_markup_ND"],
    "delivery_object": {"order_with": DeliveryMethodKey.INPOST,
                        "warehouse": pl_cart_var["warehouse_name_magazyn_glowny"],
...
product_15_nd_pickup_gniezno_inpost.update(common_test_data.copy())
product_15_nd_pickup_gniezno_inpost.setdefault("scenario", scenario3)

product_15_dw_pickup_gniezno_dhlpop = {
    "product_number": pl_cart_var["product_number_15"],
    "product_markup": pl_cart_var["product_markup_DW"],
...
product_15_dw_pickup_gniezno_dhlpop.update(common_test_data.copy())
product_15_dw_pickup_gniezno_dhlpop.setdefault("scenario", scenario3)

product_15_nd_pickup_gniezno_dhlpop = {
    "product_number": pl_cart_var["product_number_15"],
    "product_markup": pl_cart_var["product_markup_ND"],
    "delivery_object": {"order_with": DeliveryMethodKey.DHLPOP,
                        "warehouse": pl_cart_var["warehouse_name_magazyn_glowny"],
...
product_15_nd_pickup_gniezno_dhlpop.update(common_test_data.copy())
product_15_nd_pickup_gniezno_dhlpop.setdefault("scenario", scenario3)
