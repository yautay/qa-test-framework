...
scenario1 = "Scenariusz: \n" \
            "Confluence - \"Ograniczenia koszyka - testy automatyczne cz.1 -- 8.1\"\n" \
...
scenario2 = "Scenariusz: \n" \
            "Confluence - \"Ograniczenia koszyka - testy automatyczne cz.1 -- 8.2, 8.3, 8.4, 8.5, 8.6, 8.7\"\n" \
            "   1. Otwiera odpowiedni produkt i dodaje go do koszyka.\n" \
...
product_8_dw = {
    "product_number": pl_cart_var["product_number_08"],
...
product_8_dw.setdefault("scenario", scenario1)
...
product_8_nd.setdefault("scenario", scenario1)

product_8_dw_pickup_from_store_alocation = {
    "product_number": pl_cart_var["product_number_08"],
    "product_markup": pl_cart_var["product_markup_DW"],
    "delivery_object": {"order_with": DeliveryMethodKey.STOREHOUSE,
...
product_8_dw_pickup_from_store_alocation.update(common_test_data.copy())
product_8_dw_pickup_from_store_alocation.setdefault("scenario", scenario2)

product_8_nd_pickup_from_store_alocation = {
    "product_number": pl_cart_var["product_number_08"],
    "product_markup": pl_cart_var["product_markup_ND"],
    "delivery_object": {"order_with": DeliveryMethodKey.STOREHOUSE,
                        "warehouse": pl_cart_var["warehouse_name_wawa_megastore"],
...
product_8_nd_pickup_from_store_alocation.update(common_test_data.copy())
product_8_nd_pickup_from_store_alocation.setdefault("scenario", scenario2)
