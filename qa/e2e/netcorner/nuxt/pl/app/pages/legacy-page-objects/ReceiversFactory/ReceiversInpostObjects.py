from TestCases.NetCornerProducts.pl_komputronik_nuxt.Lib.PageLocators.LayersLocators import (
    NewReceiverInpostLayerLocators,
)
...
class ReceiversInpostObjects(CommonReceiversPickupObjects):
    """
    CheckoutReceiversInpostObjects encapsulates Inpost delivery method tile objects
    """
    ...
    def _get_available_objects(self, location: str):
        self.send_keys(self.wait_for.element_visible(NewReceiverInpostLayerLocators.INPUT_postal_code),
                       location, clear=True)
        self.wait_for.element_visible(NewReceiverInpostLayerLocators.BUTTON_search_postal_code).click()
        self.get_objects()

    def back_to_checkout(self):
        self.wait_for.element_visible(NewReceiverInpostLayerLocators.BUTTON_close_layer).click()
    ...
    def fill_new_receiver_object(self):
        ...
        self.wait_for.element_visible(NewReceiverInpostLayerLocators.CONTAINER)
