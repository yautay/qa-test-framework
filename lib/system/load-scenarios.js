...
function loadScenarios(site, hosts) {
    ...
    function processSuiteFile(suitePath, labelPrefix) {
        ...
        suiteScenarios.forEach(scenario => {
            ...
            let {testUrl, referenceUrl} = urls.buildUrl(channel, hosts);
            ...
            if (scenario.label.includes("disabled-js")) {
                scenario.onBeforeScript = './../../lib/engine-scripts/disable-js.js';
            }
            if (!scenario.onBeforeScript) {
                scenario.onBeforeScript = './../../lib/engine-scripts/silence-browser-console.js';
            }
