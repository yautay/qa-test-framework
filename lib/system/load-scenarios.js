...
function loadScenarios(site) {
    ...
    const siteConfigPath = path.join(siteDir, 'tests/config.json');
    ...
    console.log("testsRootDir", testsRootDir)
    console.log("siteConfigPath", siteConfigPath)
    ...
    function processSuiteFile(suitePath, labelPrefix) {
        ...
        suiteScenarios.forEach(scenario => {
            ...
            scenario.onBeforeScript = scenario.onBeforeScript || './../../lib/system/silence-browser-console.js';
