...
module.exports = {
  scenarios: [
    {
      label: 'komputronik-pl product-page tests-rwd-front-products html-cache 54244150',
    ...
    {
      label: 'komputronik-pl product-page tests-rwd-front-products no-html-cache 54244150',
